        ...
        <>
          ...
          <div className="w-full pt-20 pb-0" style={{ backgroundColor: DARK }}>
            ...
            <Wrap className="pb-16">
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  <p className="text-[10px] uppercase tracking-widest text-white/30 mb-3">Before</p>
                  <Placeholder label="Old uhdacm.org screenshot — upload here" aspect="aspect-[4/3]" dark />
                </div>
                <div>
                  <p className="text-[10px] uppercase tracking-widest mb-3" style={{ color: BRAND }}>After</p>
                  <Placeholder label="New uhdacm.org — Mockup.gif or final screenshot" aspect="aspect-[4/3]" dark />
                </div>
              </div>
            </Wrap>
          ...
          <Wrap className="py-20">
            ...
            <p className="text-gray-700 leading-relaxed text-base mb-5 max-w-2xl">
              uhdacm.org is the public face of UHD's ACM chapter — a high-traffic student platform that serves as the primary discovery point for tech opportunities at the university. The existing site had a real problem: it looked generic, felt completely static, and gave prospective members no reason to stay. The organization had outgrown the site it had.
            </p>
            <p className="text-gray-700 leading-relaxed text-base max-w-2xl">
              The project had four clear objectives: establish a visual identity that actually felt like ACM, add interaction design that matched modern expectations, build an Events system students could actually use to find what's happening, and turn the homepage into something that could convert a curious student into an active member — with a "Why Join" section that makes the value explicit.
            </p>
          </Wrap>
          ...
          <Wrap className="py-20">
            ...
            <p className="text-gray-500 leading-relaxed mb-12 max-w-2xl">
              Before anything touched Figma, I interviewed students across the department. I wanted to understand how — and whether — they used the existing site, what would make an ACM web presence genuinely useful to them, and where the current experience was quietly failing. What came back wasn't surprising in hindsight, but it was specific enough to be useful.
            </p>

            <Label>What We Heard</Label>
            <div className="space-y-5 mb-16">
              {[
                '"I didn\'t even know ACM had a website. I just heard about events through Instagram."',
                ...
                '"I wanted to join but I didn\'t know where to start — the site didn\'t help."',
              ].map((quote) => (
                <p key={quote}
            ...
            <div className="grid sm:grid-cols-3 gap-3">
              {[
                ...
                },
                {
                  ...
                  detail: 'No hover states, no transitions, no scroll behavior — nothing that indicated the site knew you were there. For an org that teaches people to build technology, the experience felt like an afterthought.',
                },
                {
          ...
          <div className="w-full bg-gray-50 py-20">
            <Wrap>
              ...
              <p className="text-gray-500 leading-relaxed mb-12 max-w-2xl">
                The audit made the problems concrete and shareable. Instead of describing what was wrong in a meeting, I could point to it.
              </p>

              <div className="space-y-10">
                {[
                  {
                    caption: 'Homepage — generic palette, no value proposition, no visual hierarchy to guide the eye',
                    placeholder: 'Old homepage screenshot (annotated) — upload here',
                  },
                  {
                    caption: 'Events page — no calendar, no filter, no structure. Finding a specific event required reading every entry in order.',
                    placeholder: 'Old events page screenshot (annotated) — upload here',
                  },
                  {
                    caption: 'Interaction audit — no hover states, no transitions, no feedback. The page didn\'t respond to the user at all.',
                    placeholder: 'Old site interaction audit screenshot — upload here',
                  },
                ].map(({ caption, placeholder }) => (
                  <div key={caption}>
          ...
          <Wrap className="py-20">
            ...
            <p className="text-gray-500 leading-relaxed mb-12 max-w-2xl">
              The old navigation was organized around how the org thought about itself — officers, news, contact — rather than what students came to the site to accomplish. I rebuilt the structure from the students' perspective outward.
            </p>
            ...
            <div className="bg-gray-50 rounded-2xl p-6">
              ...
              <p className="text-sm text-gray-700 leading-relaxed">
                Each label should answer a question a student is already asking.{' '}
                <strong className="text-gray-900">"What is ACM?" → About. "What's happening?" → Events. "How do I reach someone?" → Contact.</strong>{' '}
          ...
          <div className="w-full bg-gray-50 py-20">
            <Wrap>
              ...
              <p className="text-gray-500 leading-relaxed mb-12">
                Each fidelity stage had a specific question it needed to answer before moving forward. Low-fi validated structure. Mid-fi tested readability and hierarchy. High-fi was where the brand system had to prove itself. Nothing advanced until the current round held up in review.
              </p>

              <div className="grid sm:grid-cols-3 gap-6 mb-4">
                {[
                  { stage: '01 — Low-fi',  note: 'Layout structure + IA validation',            placeholder: 'Low-fi wireframe sketch — upload Figma screenshot' },
                  { stage: '02 — Mid-fi',  note: 'Typography, spacing, content placement',       placeholder: 'Mid-fi Events page wireframe — upload Figma screenshot' },
                  { stage: '03 — High-fi', note: 'Full brand system, dark UI, orange accents',   placeholder: 'Hi-fi final Figma screen — upload screenshot' },
              ...
              <p className="text-xs text-gray-400 italic mb-16">↑ Drop your Figma progression screenshots here — the calendar/events page evolution is a great candidate</p>

              {/* Events system spotlight */}
          ...
          <div className="w-full py-24" style={{ backgroundColor: DARK }}>
            <div className="max-w-3xl mx-auto px-6 sm:px-10">
                ...
                {[
                  {
                    ...
                    body: '"What does ACM do?" "How do I join?" "When\'s the next workshop?" — questions students have but rarely find answers to on a club website. The chatbot handles all of them directly.',
                  },
                  {
              ...
              <Placeholder label="ACM Assistant chatbot UI — hi-fi screen or demo gif" aspect="aspect-video" dark />
            </div>
          </div>
          ...
          <Wrap className="py-20">
            ...
            <div className="mb-16">
              ...
              <p className="text-gray-500 text-sm leading-relaxed mb-6 max-w-lg">
                The homepage needed to do two things at once: look unmistakably like ACM, and give a student who's never heard of the org a reason to care. Bold display type, dark background, orange accents, geometric decorative elements — and an expanded lower section that makes the value of joining explicit.
              </p>
              <Placeholder label="Final homepage mockup or Mockup.gif — from /projects/UHDACM/" aspect="aspect-video" />
            </div>
              ...
              {[
                {
                  ...
                  image: '/projects/UHDACM/Events Page.gif',
                },
                {
                  screen: '"Why Join UHD ACM?" — Value Proposition Section',
                  note: 'An interactive card carousel on the homepage that breaks down what ACM actually offers: Events, Opportunity, Mentorship, and Technical Skills. Designed to answer the question a prospective student is silently asking — "what\'s in it for me?" — before they leave the page.',
                  image: '/projects/UHDACM/Why Join Us.jpg',
                },
                {
                  screen: 'About Page — Mission, History & Leadership',
                  note: 'The old About page was a blank slate — no story, no personality, no reason to care. The redesign introduced three net-new sections: a four-pillar mission breakdown (Growth, Community, Innovation, Support) that communicates what ACM stands for at a glance; "Our Journey," a full org timeline from the chapter\'s founding in 2012 to today; and a redesigned Leadership section that puts real faces and names to the org. Prospective members now land on a page that actually tells them who ACM is.',
                ...
                },
                {
                  ...
                  placeholder: 'ACM Assistant chatbot UI — final hi-fi screen or demo gif',
                },
          ...
          <div className="w-full bg-gray-50 py-20">
            <Wrap>
              ...
              <p className="text-gray-500 leading-relaxed mb-12 max-w-2xl">
                These aren't metrics from a test environment. The redesign shipped to a real audience, with real expectations — and three features that didn't exist before.
              </p>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 border border-gray-100 rounded-2xl overflow-hidden mb-10">
                {[
                  ...
                  <div key={label} className="px-6 py-6 border-r border-b sm:border-b-0 border-gray-100 last:border-r-0">
                    <p className="text-3xl font-display mb-1" style={{ color: BRAND }}>{stat}</p>
