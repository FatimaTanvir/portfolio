...
export default function Creatives() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col overflow-x-hidden">
      <Navbar />
      <div className="flex-1 flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12 w-full max-w-[1600px] mx-auto">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-display mb-1 sm:mb-2 text-center px-2 pt-4 pb-2">
            I like to <span className="text-blue-800">get creative</span>, and <span className="text-green-700">make things</span>.
          </h1>
        <p className="text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl text-gray-500 mb-0 sm:mb-2 text-center px-2">
      ...
      <div className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 py-2 max-w-[1600px] mx-auto w-full">
        <h2 className="text-3xl sm:text-3xl md:text-4xl xl:text-5xl font-display text-center mb-2 py-4">
